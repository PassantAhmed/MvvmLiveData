...
public class AnimatedCharacterRepoImpl implements AnimatedCharacterRepo {
    ...
    @Override
    public MutableLiveData<List<AnimatedCharacter>> getCharacters(){
        MutableLiveData<List<AnimatedCharacter>> animatedCharactersData = new MutableLiveData<>();
        animatedCharactersData.setValue(characters);
        return animatedCharactersData;
    }
